...
בגרף מוצג ממוצע הפספוסים של כל אלגוריתם. כמה קורסים סטודנטים לא קיבלו בממוצע\
...
נגדיר שלושה משתנים חדשים (אין לנו מושג כל כך איך מחשבים אותם - כנראה שלא מחשבים)
...
ניתן לראות שככל שwi גדל, התועלת של האלגוריתם(?) יורדת חוץ מBMP. זאת אומרת שחוץ מBMP במידה ו20% מהסטודנטים יהיו אסטרטגיים האלגוריתמים שלנו יפעלו אחרת
